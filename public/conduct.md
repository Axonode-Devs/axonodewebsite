# Axonode: Code Of Conduct
**Last Updated:** 5.05.2026

## 1. The Core Philosophy
Axonode is a sanctuary for builders, thinkers, and visionaries. We operate on the principle of **Collaborative Integrity**. We are here to push boundaries, but never at the expense of our peers.

## 2. Expected Behavior

All members of Axonode are expected to:

- **Share with Purpose:** Bring value to the community. Help others refine their ideas just as you seek help with yours.

- **Respect the "Kitchen":** Innovation is messy. Be patient with works-in-progress and offer constructive, kind feedback.
...
1. **Direct Dialogue:** Try to resolve it professionally between parties first.
2. **Mediation:** If unresolved, the matter should be brought to the **Axonode Board Authority**.
